...
const Pratners = () => {
  return (
    <div className='p-8 mt-8 hidden md:block bg-gray-200 dark:bg-white/10 '>
      <div className="container">
        <div data-aos="zoom-out" data-aos-offset="0" data-aos-delay="0" className="grid grid-cols-5 gap-3 place-items-center opacity-50 ">
